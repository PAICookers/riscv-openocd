...
const struct flash_device flash_devices[] = {
	...
	FLASH_ID("win w25q01nw",        0x13, 0x00, 0x12, 0xdc, 0xc7, 0x002160ef, 0x100, 0x10000, 0x8000000),
	...
	FLASH_ID("issi is25lq025e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0009409d, 0x100, 0x1000,  0x8000),
	FLASH_ID("issi is25wq025e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0009709d, 0x100, 0x1000,  0x8000),
	FLASH_ID("issi is25lq512e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0010409d, 0x100, 0x1000,  0x10000),
	FLASH_ID("issi is25wq512e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0010709d, 0x100, 0x1000,  0x10000),
	FLASH_ID("issi is25lq010e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0011409d, 0x100, 0x1000,  0x20000),
	FLASH_ID("issi is25wq010e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0011709d, 0x100, 0x1000,  0x20000),
	FLASH_ID("issi is25lq020e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0012409d, 0x100, 0x1000,  0x40000),
	FLASH_ID("issi is25wq020e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0012709d, 0x100, 0x1000,  0x40000),
	FLASH_ID("issi is25lq040e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0013409d, 0x100, 0x1000,  0x80000),
	FLASH_ID("issi is25wq040e",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0013709d, 0x100, 0x1000,  0x80000),
	FLASH_ID("issi is25lq080d",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0014609d, 0x100, 0x1000,  0x100000),
	FLASH_ID("issi is25wq080d",     0x03, 0xeb, 0x02, 0x20, 0xc7, 0x0014709d, 0x100, 0x1000,  0x100000),
	FLASH_ID("issi is25lp016d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0015609d, 0x100, 0x10000, 0x200000),
	FLASH_ID("issi is25wp016d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0015709d, 0x100, 0x10000, 0x200000),
	FLASH_ID("issi is25lp032d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0016609d, 0x100, 0x10000, 0x400000),
	FLASH_ID("issi is25wp032d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0016709d, 0x100, 0x10000, 0x400000),
	FLASH_ID("issi is25lp064d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0017609d, 0x100, 0x10000, 0x800000),
	FLASH_ID("issi is25wp064d",     0x03, 0x00, 0x02, 0xd8, 0xc7, 0x0017709d, 0x100, 0x10000, 0x800000),
	...
	FLASH_ID("issi is25lp01g",      0x13, 0xec, 0x12, 0xdc, 0xc7, 0x001b609d, 0x100, 0x10000, 0x8000000),
	FLASH_ID("issi is25wp01g",      0x13, 0xec, 0x12, 0xdc, 0xc7, 0x001b709d, 0x100, 0x10000, 0x8000000),
